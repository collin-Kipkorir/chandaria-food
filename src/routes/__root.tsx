  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/ed7a765c-d896-46e0-a067-413bce810165/id-preview-0cb8b211--f2728cda-ed89-40ea-8120-2c0a083209c4.lovable.app-1781167259630.png",
      },
      {
        name: "twitter:image",
        content:
    ...
    <QueryClientProvider client={queryClient}>
      {!isFirebaseConfigured && (
        <div className="bg-amber-100 px-4 py-2 text-center text-xs text-amber-900">
          ...
          <code className="mx-1">VITE_FIREBASE_*</code> env vars to enable cloud sync.
        </div>
      )}
      <MaintenanceGate>
        <Outlet />
